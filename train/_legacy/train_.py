...
def parse_args():
    ...
    """3D_UXNet"""
    parser.add_argument('--nn_module', default='3D_UXNet', help='name of neural network module')
    parser.add_argument('--resume_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/3D_UXNet_2.yingmuzhi")
    parser.add_argument('--csv_path', default="/home/yingmuzhi/microDL_3_0/src/csv/3D_UXNet_2.csv")
    parser.add_argument('--save_best_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/best_3D_UXNet_2.yingmuzhi")
...
def main(args):
    ...
    trainer.get_parameter_number(trainer.net, param_type_str="float16")
    trainer.get_flops(trainer.net, input_tensor=torch.randn((1, 4, 32, 256, 256)))  # also depend on your input_tensor
