...
def parse_args():
    ...
    """3DCapsule"""
    parser.add_argument('--nn_module', default='3DCapsule', help='name of neural network module')
    parser.add_argument('--resume_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/3DCapsule.yingmuzhi")
    parser.add_argument('--csv_path', default="/home/yingmuzhi/microDL_3_0/src/csv/3DCapsule.csv")
    parser.add_argument('--save_best_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/best_3DCapsule.yingmuzhi")
