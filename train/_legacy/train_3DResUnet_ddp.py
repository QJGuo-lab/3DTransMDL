...
def parse_args():
    ...
    """3DResUnet"""
    parser.add_argument('--nn_module', default='3DResUnet', help='name of neural network module')
    parser.add_argument('--resume_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/3DResUnet_5.yingmuzhi")
    parser.add_argument('--csv_path', default="/home/yingmuzhi/microDL_3_0/src/csv/3DResUnet_5.csv")
    parser.add_argument('--save_best_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/best_3DResUnet_5.yingmuzhi")
