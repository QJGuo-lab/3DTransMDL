...
def parse_args():
    ...
    """3DUXNet2"""
    parser.add_argument('--nn_module', default='3D_UXNet_2', help='name of neural network module')
    parser.add_argument('--resume_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/3D_UXNet2_5.yingmuzhi")
    parser.add_argument('--csv_path', default="/home/yingmuzhi/microDL_3_0/src/csv/3D_UXNet2_5.csv")
    parser.add_argument('--save_best_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/best_3D_UXNet2_5.yingmuzhi")
