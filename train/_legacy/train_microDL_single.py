...
def parse_args():
    ...
    """microDL"""
    parser.add_argument('--nn_module', default='microDL_single', help='name of neural network module')
    parser.add_argument('--resume_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/microDL_single.yingmuzhi")
    parser.add_argument('--csv_path', default="/home/yingmuzhi/microDL_3_0/src/csv/microDL_single.csv")
    parser.add_argument('--save_best_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/best_microDL_single.yingmuzhi")
    ...
    # parser.add_argument('--resume_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/transMDL_single_phase.yingmuzhi")
    # parser.add_argument('--csv_path', default="/home/yingmuzhi/microDL_3_0/src/csv/transMDL_single_phase.csv")
    # parser.add_argument('--save_best_path', default="/home/yingmuzhi/microDL_3_0/src/yingmuzhi/best_transMDL_single_phase.yingmuzhi")
    # parser.add_argument('--batch_size', type=int, default=12, help='size of each batch')
    # parser.add_argument('--nn_kwargs', default=dict())
...
def main(args):
    ...
    train_dataset = MicroDLDataset(path = train_path1, train=True, multimodal=False, single_signal_channel="Retardance", single_target_channel="405")
    ...
    validation_dataset = MicroDLDataset(path = train_path1, train=False, multimodal=False, single_signal_channel="Retardance", single_target_channel="405")
    ...
    for epoch in range(trainer.current_epoch, args.epoch):
        ...
        # validation
        validation_mean_loss, metrics = trainer.evaluate_one_epoch(validation_loader, 62., 87.)
