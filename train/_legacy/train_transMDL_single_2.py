...
def main(args):
    ...
    train_path1 = "/home/yingmuzhi/microDL_2_0/data_phase2actin/output"

    

    train_dataset = MicroDLDataset(path = train_path1, train=True, multimodal=False, single_signal_channel="phase", single_target_channel="568")
    ...
    validation_dataset = MicroDLDataset(path = train_path1, train=False, multimodal=False, single_signal_channel="phase", single_target_channel="568")
