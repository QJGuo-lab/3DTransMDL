...
def reduct_dimension(input, label):
    # input = input.reshape(1, 256, 256)
...
class MicroDLDataset(Dataset):
    ...
    def __init__(
        ...
        position: dict={"train":    
                            ...
                            ['000', '001', '002', '003', '004', '005', '006', '007', '008', '009', '010', '011', '012', '013', '014', '015', '016', '017', '018', '019', '020', '23', '024', '025', '026', '027', '028', '029', '030']
                            # ['000']
                        ,"val":      
                            # ["021", "022", "023", "024"],
                            ["021", "022"],
    ...
    def __getitem__(self, index):
        ...
        if self.transform:
            # make 3D to 2D
            input, label = reduct_dimension(input, label)
...
if __name__ == "__main__":
    ...
    train_path1 = "/home/yingmuzhi/microDL_2_0/src/data_retardance2ex561em700/output"
    # train_dataset = MicroDLDataset(
    #     path = train_path1, 
    #     train=True, 
    #     multimodal=False, 
    #     single_signal_channel="img_Retardance", 
    #     single_target_channel="img_ex561em700",
